    ...
    <div>
        ...
        <div className='w-screen h-screen bg-neutral-900 p-10 flex flex-col'>
            ...
            <div className='w-4/6 mx-auto flex flex-col md:flex-row gap-5 justify-around my-10'>
                <div className='text-black bg-cyan-50 hover:bg-neutral-400 border-2 border-neutral-900 px-10 py-3 flex flex-col items-center justify-between rounded-lg'>
                    <h2 className='text-3xl font-bold my-2 '>Free</h2>
                    <p className='mt-2 mb-5'>for first 3 promotion</p>
                    <div className='font-medium text-lg text-red-600 border-t-2 border-neutral-500 py-15'>
                        <p>no early access</p> 
                        <p>no analysis report</p> 
                        <p>no profile customization</p> 
                    </div>
                </div>
                <div className='text-black bg-green-100 hover:bg-neutral-400 border-2 border-neutral-900 px-10 py-3 flex flex-col items-center justify-between rounded-lg'>
                    <h2 className='text-3xl font-bold my-2 '>5$ / month</h2>
                    <p className='mt-2 mb-5'>Premium</p>
                    <div className='font-medium text-lg text-green-600 border-t-2 border-neutral-500 py-15'>
                        <p>early access</p> 
                        <p>Monthly analysis</p> 
                        <p>cusmotized profile</p> 
                    </div>
                </div>
                <div className='text-black bg-amber-400 hover:bg-neutral-400 border-2 border-neutral-900 px-10 py-3 flex flex-col items-center justify-between rounded-lg'>
        ...
        <div className='w-screen h-fit bg-neutral-900 p-10'>
            <h2 className='font-bold text-5xl md:text-7xl mb-5 ml-5 md:ml-0 text-white'>Find, Connect, Promote</h2>
        </div>
    </div>
  )
}
